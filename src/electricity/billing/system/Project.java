...
public class Project extends JFrame implements ActionListener {
    ...
    Project(String atype) {
        ...
        // Start server if admin
        if (atype.equals("Admin")) {
            new Thread(() -> BillingServer.startServer()).start();
        }
        ...
        // Add Remote Payment option
        JMenuItem remotePayment = new JMenuItem("Remote Payment");
        remotePayment.setFont(new Font("monospaced", Font.PLAIN, 12));
        remotePayment.setBackground(Color.WHITE);
        remotePayment.setIcon(new ImageIcon(image7));
        remotePayment.setMnemonic('T');
        remotePayment.addActionListener(this);
        remotePayment.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, ActionEvent.CTRL_MASK));
        user.add(remotePayment);
...
//        } 
            ...
            new GenerateBill(meter);}
//        } else if (msg.equals("Remote Payment")) {
//            new RemotePayment();
//        }
    }
